...
- (void)viewDidLoad {
    ...
    imgWidth = (kScreenWidth-1-1-1-1-1)/4;
...
#pragma mark - 裁剪图片大小
                    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
                        //裁切
                        UIImage * image = [self imageWithImage:[UIImage imageWithCGImage:[asset aspectRatioThumbnail]] scaledToSize:CGSizeMake([UIImage imageWithCGImage:[asset aspectRatioThumbnail]].size.width, [UIImage imageWithCGImage:[asset aspectRatioThumbnail]].size.height)];
