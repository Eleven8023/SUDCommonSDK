...
- (void)viewDidLoad {
    ...
    [takePhotoBtn setFrame:CGRectMake([UIScreen mainScreen].bounds.size.width / 2 - 20, 30, 40, 40)];
    [takePhotoBtn setBackgroundImage:[UIImage imageNamed:@"camera.png"] forState:UIControlStateNormal];
    [takePhotoBtn addTarget:self action:@selector(takePhoto) forControlEvents:UIControlEventTouchUpInside];
    [footerView addSubview:takePhotoBtn];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        UIImage *groupImage = [groupImageArray objectAtIndex:indexPath.row];
